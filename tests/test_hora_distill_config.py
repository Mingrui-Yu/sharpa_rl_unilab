...
from sharpa_rl_unilab.training import hora_distill_config as distill_config

# distill_config's root_dir parameter expects the directory containing "conf";
# after the packaging move that is the sharpa_rl_unilab package directory.
_PACKAGE_ROOT = Path(__file__).resolve().parents[1] / "src" / "sharpa_rl_unilab"
