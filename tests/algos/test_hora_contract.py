...
def test_hora_ppo_logs_when_symmetry_is_logging_only(
    ...
    with caplog.at_level(logging.WARNING, logger="sharpa_rl_unilab.algos.hora.ppo"):
        HoraPPO(
            cast(Any, actor),
            cast(Any, critic),
            cast(Any, object()),
...
def test_hora_sac_learner_derives_priv_info_from_critic_contract() -> None:
    from sharpa_rl_unilab.algos.hora.sac_learner import derive_priv_info_from_critic_obs
...
def test_hora_sac_distilled_student_forward_does_not_require_priv_info() -> None:
    from sharpa_rl_unilab.algos.hora.distill import HoraSACDistillActor, HoraSACDistillShared
...
def test_hora_appo_learner_derives_priv_info_from_critic_contract() -> None:
    from sharpa_rl_unilab.algos.hora.appo_learner import _derive_priv_info_from_critic
...
def _make_hora_appo_learner(**algorithm_overrides):
    from sharpa_rl_unilab.algos.hora.appo_learner import HoraAPPOLearner
    from sharpa_rl_unilab.algos.hora.models import (
        HoraActorModel,
        HoraCriticModel,
...
def test_hora_appo_runner_builds_shared_actor_critic_core() -> None:
    from sharpa_rl_unilab.algos.hora.appo_runner import HoraAPPORunner
...
def test_hora_appo_worker_builds_shared_actor_critic_core() -> None:
    from sharpa_rl_unilab.algos.hora.appo_worker import hora_appo_collector_fn
...
def test_hora_appo_play_builds_explicit_shared_actor_core() -> None:
    from sharpa_rl_unilab.training.play_hora_appo import play_hora_appo
...
def _patch_hora_appo_play_fakes(monkeypatch: pytest.MonkeyPatch, *, actor_cls: type) -> None:
    ...
    import sharpa_rl_unilab.training.play_hora_appo as hora_appo
...
def test_hora_appo_resume_rejects_inconsistent_shared_checkpoint() -> None:
    from sharpa_rl_unilab.algos.hora.appo_runner import _validate_hora_shared_checkpoint
